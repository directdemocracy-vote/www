...
The app server sign only the vote contents: referendum signature, ballot number, vote number and answer.
The ballot number is series of random bits generated by the app and guarantying the uniqueness of the vote.
The vote number is 1 for the first vote of the citizen and is incremented each time the citizen votes again, replacing their previous vote until the deadline.
