...
1. Install the [DirectDemocracy app](https://app.directdemocracy.vote) on your cell phone (iOS or Android)
   - Android: get the app from the play store [here](https://play.google.com/store/apps/details?id=vote.directdemocracy.app). Alternatively, you can download the [APK](https://github.com/directdemocracy-vote/app/releases/download/2.0.62/directdemocracy-2.0.62.apk) file from the app's [release page](https://github.com/directdemocracy-vote/app/releases) and run it to install.
